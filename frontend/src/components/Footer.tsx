...
export function Footer() {
  return (
    <footer className="bg-ink-900 text-ink-100">
      ...
      <div className="container-page py-6 grid grid-cols-1 md:grid-cols-3 gap-4 items-center text-xs">
        <p className="text-ink-300">© 2026 PROCHECK Safety</p>
        <p className="text-ink-300 text-center">RFC pendiente de registro legal</p>
